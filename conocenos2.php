...
<body>
    	...
    	<div class="row">
        <div class="col-sm-3 col-md-2 flot-izq">
        	...
        	<h1>Conocenos</h1>
					...
					<h3>¿Es lo mismo un material biodegradable que uno ecológico?</h3>
						<p>
							...
							El menor impacto sobre el medio ambiente se ve reflejado en una disminución de la huella de carbono de los productos, una vida útil más prolongada, y la utilización de materiales biodegradables que no son acumulables, como por ejemplo, el bambú.<br>
							¿Es bueno el bambú para el medioambiente? <br>
							Sí, pero ¿por qué? <br>
							Tiene muy rápido crecimiento (secuestrando en el proceso grandes cantidades de CO2, gas de efecto invernadero),<br>
							Contiene <strong> agentes antibacterianos de origen natural </strong>, por lo cual no necesita fertilizantes ni pesticidas para crecer. <br>
      ...
      <div class="col-sm-3 col-md-2 col-md-offset-1 link-ml">
				<img width=200px height="200px" class="img-responsive"  	src="grafica/MERAKI-2-baja.jpg">
				<div class="comprar">
